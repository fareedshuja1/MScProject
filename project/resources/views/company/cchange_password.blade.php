...
@section('title')
{{Session::get('company_name')}} | Change Password | Findajob.af | Find jobs in Afghanistan
@endsection
	 ...
	 <!--widget start-->
        ...
        <div class="col-md-9">
            ...
            <div class="col-md-12">
                ...
                <form action="cchange_password_query" class="cmxform" method="post" id="cchange_password_query" role='form'>
